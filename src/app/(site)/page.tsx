...
import checkIcon from "../../../public/icons/diamond.svg";
const HomePage = () => {
  return (
    <>
      <section
      ...
      >
        ...
        border-opacity-10"
        >
          <Image src={Calendar} className="rounded-2xl" alt="Banner" />
        </div>
      </section>
      <section className="relative">
        <div
      ...
      >
        <TitleSection
          ...
          pill="Pricing"
          subheading="Experience the power of our platform with a monthly subscription."
        ></TitleSection>
        <div
          className="flex
        flex-col-reverse
